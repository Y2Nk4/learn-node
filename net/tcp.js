...
const clients = net.connect({
    port: 2222,
    //localAddress: '192.168.50.236' // set a wrong localAddr
    // If you set a wrong local Addr,
    // Node will throw a EADDRNOTAVAIL Error on socket,
    // saying it's not available to bind this IP
}, () => {
    // 'connect' listener
